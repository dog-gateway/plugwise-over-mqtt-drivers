        ...
        extends PlugwiseMQTTDriverInstance implements MeteringPowerOutlet
{
            ...
            BundleContext context)
    {
        ...
        this.logger = context
                ...
                .getLogger(PlugwiseMQTTMeteringPowerOutletDriverInstance.class);
    ...
    {
        // log the message
        this.logger.info("Received energy state: " + message.toString());
    ...
    {
        // log the message
        this.logger.info("Received power state: " + message.toString());
    ...
    {
        // log the message
        this.logger.info("Received circle state: " + message.toString());
